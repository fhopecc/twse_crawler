...
def 以大宗商品價預測至次年底各季財務數據(股票, 財務數據名稱, 大宗商品每日現價
    ...
    def objective(trial):
        ...
        changepoint_prior_scale = trial.suggest_float("changepoint_prior_scale", 0.5, 1.0, log=True)
        holidays_prior_scale = trial.suggest_float("holidays_prior_scale", 5.0, 20.0, log=True)
